...
////////////////// VECTOR ////////////////////////
	...
	// *it_vec_std_const = 4;
		...
		std::vector<int>::const_iterator	it_vec_std_const = vec_std.end();
	...
	//	*it_vec_ft_const = 6;
		...
		std::cout << STD_PR_COLOR << "STD Vector::const_iterator == vector::iterator: " << (it_vec_std_const == it_std_swap1) << std::endl;
		std::cout << FT_PR_COLOR <<  " FT Vector::const_iterator == vector::iterator: " << (it_vec_ft_const == it_ft_swap1) << std::endl;

		std::cout << STD_PR_COLOR << "STD vector == vector: " << (vec_std == vec_std) << std::endl;
		std::cout << FT_PR_COLOR <<  " FT vector == vector: " << (vec_ft == vec_ft) << std::endl;
...
/////////////////////////////////////////////////////////////////// |    |  /   \  |
	...
	//	std::cout << map_std[7] << std::endl;
		...
		std::cout << STD_PR_COLOR << "STD map ERASE(-11) return: " << map_std2.erase(-11) << std::endl;
		std::cout <<  FT_PR_COLOR << " FT map ERASE(-11) return: " <<	map_ft2.erase(-11)  << std::endl;
		std::cout << STD_PR_COLOR << "STD map ERASE(-11) return: " << map_std2.erase(-11) << std::endl;
		std::cout <<  FT_PR_COLOR << " FT map ERASE(-11) return: " <<	map_ft2.erase(-11) << std::endl;
	...
	//	map_ft.try_leftrotate(11);
		...
		std::cout << FT_PR_COLOR <<  " FT revers iterator REND()++ = " << it_map_ft2->second << std::endl;

		// ft::map<int, int>	ft_map3(map_ft.begin(), map_ft.end());
		// ft_map3.print();

		std::cout << STD_PR_COLOR << "STD map == map: " << (map_std == map_std) << std::endl;
		std::cout << FT_PR_COLOR <<  " FT map == map: " << (map_ft == map_ft) << std::endl;
